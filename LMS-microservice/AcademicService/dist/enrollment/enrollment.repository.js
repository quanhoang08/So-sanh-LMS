...
let EnrollmentRepository = class EnrollmentRepository extends typeorm_1.Repository {
    dataSource;
    constructor(dataSource) {
        super(enrollment_entity_1.Enrollment, dataSource.createEntityManager());
    ...
    async createEnrollment(enrollment) {
        return this.saveOneLecturer(enrollment);
    }
};
